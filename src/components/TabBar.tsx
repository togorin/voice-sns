...
const HomeIcon = () => (
  <svg 
    ...
    className="h-6 w-6" 
    viewBox="0 0 16 16" // 元画像のピクセルグリッドに合わせて調整
    fill="currentColor" // 現在のテキスト色で塗りつぶす
  >
    {/* 添付画像を元に作成されたパスデータ */}
    <path d="M7 0h2v1H7V0zm-2 1h1v1H5V1zm6 0h1v1h-1V1zM4 2h1v1H4V2zm7 0h1v1h-1V2zM3 3h1v1H3V3zm7 0h1v1h-1V3zm-7 1h7v1H3V4zm0 1h1v1H3V5zm6 0h1v1H9V5zm-6 1h1v1H3V6zm6 0h1v1H9V6zm-6 1h1v1H3V7zm3 0h1v1H6V7zm3 0h1v1H9V7zM5 8h1v1H5V8zm4 0h1v1H9V8zm-5 1h1v1H4V9zm6 0h1v1h-1V9zm-5 1h2v1H5v-1z"/>
  </svg>
);
