...
// 各アイコンのSVGコンポーネント
const HomeIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M21.5,11.2,12.9,2.8a1.6,1.6,0,0,0-2.2,0L2.1,11.2A1.6,1.6,0,0,0,3.5,14H4v7a1,1,0,0,0,1,1H19a1,1,0,0,0,1-1V14h.5A1.6,1.6,0,0,0,21.5,11.2ZM18,20H6V12.9l6-5.4,6,5.4Z" /></svg>;
